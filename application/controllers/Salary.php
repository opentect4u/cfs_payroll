...
class Salary extends CI_Controller
{
    ...
    public function eardeduedit()
	{
        ...
        $data['epayhead'] = $this->Admin_Process->f_get_particulars("md_pay_head", NULL, array('pay_flag'=>'E','sl_no NOT IN('.$sql.')'=> NULL), 0);
        
        $data['dpayhead'] = $this->Admin_Process->f_get_particulars("md_pay_head", NULL, array('pay_flag'=>'D','sl_no NOT IN('.$sql.')'=> NULL), 0);
        $this->load->view('post_login/payroll_main');
